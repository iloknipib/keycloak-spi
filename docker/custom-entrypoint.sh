...
mv /opt/jboss/keycloak/keycloak-metrics-spi-1.0.4.jar /opt/jboss/keycloak/standalone/deployments/keycloak-metrics-spi-1.0.4.jar
mv /opt/jboss/keycloak/dehaat-keycloak-spi-1.0.jar /opt/jboss/keycloak/standalone/deployments/dehaat-keycloak-spi-1.0.jar
